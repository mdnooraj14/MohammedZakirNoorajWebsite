...
import { Github, Linkedin, Mail, ExternalLink, Download, MessageCircle, Send, X, Sun, Moon } from "lucide-react";
    ...
    <div className="min-h-screen w-full overflow-x-hidden bg-gradient-to-b from-white via-slate-50 to-slate-100 text-slate-900 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 dark:text-slate-100">
      ...
      <main id="top" className="pt-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <a
                  href="https://drive.google.com/file/d/1nBXouS_zcNa2kRHKVaCSbJuI3CZmWKQV/view?usp=sharing"
          ...
          <Card>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="mt-3 sm:mt-0">
                <a className="text-sky-600 dark:text-sky-400 hover:underline" href="https://it4yourbusiness.in">Company Site</a>
              </div>
            </div>
        ...
        <Section id="education" title="Education & Certifications">
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white">BTECH in Information Technology</h3>
              <p className="text-slate-600 dark:text-white/70">2020-2024 • GMR Institute of Technology </p>
            </Card>
            <Card>
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Intermediate (M.P.C)</h3>
              <p className="text-slate-600 dark:text-white/70">2018-2020 • Naryana Jr College</p>
            </Card>
            <Card>
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white">10th • Sri Chaitanya Techno School</h3>
              <p className="text-slate-600 dark:text-white/70">2017-2018 </p>
            </Card>
            <Card>
